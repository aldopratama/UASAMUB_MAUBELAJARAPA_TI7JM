...
public class PelatihanDetailAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Kategori").child(jenis_pelatihan_baru);
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // menimpa data yang ada dengan data yang baru
                title_pelatihan.setText(dataSnapshot.child("nama_pelatihan").getValue().toString());
                location_pelatihan.setText(dataSnapshot.child("lokasi").getValue().toString());
                guru_spot_pelatihan.setText(dataSnapshot.child("guru").getValue().toString());
                konsul_pelatihan.setText(dataSnapshot.child("konsul").getValue().toString());
                sertifikat_pelatihan.setText(dataSnapshot.child("sertifikat").getValue().toString());
