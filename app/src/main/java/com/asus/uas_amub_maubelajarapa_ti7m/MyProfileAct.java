...
public class MyProfileAct extends AppCompatActivity {
    ...
    LinearLayout item_my_pelatihan;
    ...
    RecyclerView mypelatihan_place;
    ArrayList<MyPelatihan> list;
    PelatihanAdapter pelatihanAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item_my_pelatihan = findViewById(R.id.item_my_pelatihan);
        ...
        mypelatihan_place = findViewById(R.id.myticket_place);
        mypelatihan_place.setLayoutManager(new LinearLayoutManager(this));
        list = new ArrayList<MyPelatihan>();
        ...
        reference2 = FirebaseDatabase.getInstance()
                .getReference().child("KelasSaya").child(username_key_new);
        reference2.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                    MyPelatihan p = dataSnapshot1.getValue(MyPelatihan.class);
                    list.add(p);
                }
                pelatihanAdapter = new PelatihanAdapter(MyProfileAct.this, list);
                mypelatihan_place.setAdapter(pelatihanAdapter);
            }
